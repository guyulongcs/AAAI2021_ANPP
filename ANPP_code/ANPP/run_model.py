...
def process_args():
    ...
    parser.add_argument('--summary_dir', default="summary.ANPP")
    parser.add_argument('--save_dir', default="save.ANPP")
    ...
    parser.add_argument('--cpu-only', default=True, help='Use only the CPU.')
...
def cmd(event_train, event_test, time_train, time_test, args):
    ...
    seq_mdl = model_core.ANPP(
        sess=sess,
        num_categories=data.num_categories+3,

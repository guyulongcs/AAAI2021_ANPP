...
def_opts = intensityRNN_core.def_opts
...
parser.add_argument('--time_parse_log', default=False)
...
args.weight_loss = Config.weight_loss_intensityRNN
args.loss_time_method = Config.loss_time_method
args.sigma_square = Config.sigma_square
args.flagMinMax = Config.flagMinMax
args.flagScale = Config.flagScale
...
def cmd(event_train, event_test, time_train, time_test, args,
    ...
    rmtpp_mdl = intensityRNN_core.IntensityRNN(
        sess=sess,
